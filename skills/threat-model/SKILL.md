...
2. The top 5 threats by likelihood x impact (id, one-line description, LxI).
...
- [AGENTS.md](../../AGENTS.md) and [WORKFLOW.md](../../WORKFLOW.md) for the
  engagement context and authorization framing this skill inherits.
